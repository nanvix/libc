...
pub use std::os::nanvix::syscall::pthread::bindings::{
    ...
    pthread_create::pthread_create, pthread_getschedparam::pthread_getschedparam,
    pthread_getspecific::pthread_getspecific, pthread_join::pthread_join,
    pthread_key_create::pthread_key_create, pthread_kill::pthread_kill,
